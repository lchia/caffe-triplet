...
/**
 * @brief Computes the triplet loss @f$
 *
 */
...
class TripletLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  ...
  Blob<Dtype> diff_sq_ap_; //cached for backward pass, (anchor - positive)^2
  Blob<Dtype> diff_sq_an_; //tmp storage for gpu forward pass, (anchor - negative)^2
